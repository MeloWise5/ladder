                      ...
                      <div className="p-0 " style={{display:'flex', flexDirection: 'row', height: '100%'}}>
                        ...
                        <div className="p-0" style={{ 
                          ...
                          <div style={{
                            ...
                            backgroundColor: ladder.budget && ladder.debt && (ladder.debt / ladder.budget) > 0.8 ? '#ff4444' : 
                                           ladder.budget && ladder.debt && (ladder.debt / ladder.budget) > 0.5 ? '#ffaa00' : '#44ff44',
                        ...
                        <div  className="p-0" style={{display:'flex', flexDirection: 'row', backgroundColor: ladder.percent_change_24h >= 0 ? 'lightgreen' : 'pink', flex: 1}}>
                          <div lg={1} className="p-0"  style={{borderRight: '1px solid black'}}>
                            <div  className="px-1"  style={{borderBottom: '1px solid black', backgroundColor: 'pink'}}>{ladder.closed_daily_transaction_count}</div>
                              <div  className="px-1"  style={{borderTop: '1px solid black', backgroundColor: 'lightgreen'}}>{ladder.open_daily_transaction_count}</div>
                            </div>
